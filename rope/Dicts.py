...
'MonitorDisplay':             'text',
'MonitorInfoText':             'DIRECTORY MONITOR:\nWatches the input target media directory for changes and updates the list of target media as files are added, removed, and renamed.',
'MonitorState':               False,
'MonitorText':                'Monitor',
...
'MaxFacesSliderAmount':            20,
'MaxFacesSliderInc':               1,
'MaxFacesSliderInfoText':          'MAX FACES:\nMaximum number of faces to track in the input media per frame. Minor speedup with fewer faces.',
'MaxFacesSliderMax':               30,
'MaxFacesSliderMin':               1,
